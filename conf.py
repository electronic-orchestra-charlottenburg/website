...
BLOG_TITLE = "Elektronisches Orchester Charlottenburg"  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -rav --delete output/ eoc@eo-charlottenburg.de:/srv/http/websites/eo-charlottenburg.de",
    ]
}
